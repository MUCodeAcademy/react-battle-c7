...
export default function About() {
  return (
    <div className="bgAbout" style={{backgroundImage: "url(./assets/7battle.png)", height: "100vh", backgroundBlendMode: "light", opacity: ".8", zIndex: "-1", textShadow: "1px 1px 0px #ffffff"}}>
<Container>    
<p>
        <strong>
